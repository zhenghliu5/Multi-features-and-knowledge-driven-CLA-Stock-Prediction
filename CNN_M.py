...
for ss in range(2,len(StockList)-2):
    ...
    class CNNModel(nn.Module):
        ...
        def __init__(self, input_size, hidden_size, num_classes):
            ...
            self.fc = nn.Linear(hidden_size * (window_size // 4), num_classes)
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig("./data/pic/CNN_M_Training Loss of " + EStockList[ss] + ".png", bbox_inches="tight")
    plt.show()
    ...
    ax.set_title('CNN_M:Stock price of '+EStockList[ss], size=14, fontweight='bold')
    ...
    plt.savefig("./data/pic/"+" CNN_M_Stock price of "+EStockList[ss]+".png", bbox_inches="tight")
    plt.show()
    ...
    # 将DataFrame保存到CSV文件
    df.to_csv("./data/results/"+StockList[ss]+"CNN_M_evaluation_metrics.csv", encoding='utf-8-sig')